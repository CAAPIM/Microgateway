...
CA microgateway provides secure service mesh for microservices with rich functionalities of the CA API gateway family including SSL/TLS, OAuth, service discovery packed in a PaaS-enabled docker container. You can easily extend the capabilities of CA microgateway by building your own policy with existing policy building capability in the API gateway family.
...
* Build your own Enterprise security policy exposed to developers in simple representations.
* Optimize network traffic by providing caching, circuit breaking and others.
